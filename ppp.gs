***************************************************************************************
*	$Id: ppp.gs,v 1.25 2008/07/03 04:34:14 bguan Exp bguan $
...
'!gxeps -R -c -i 'mytmpdir'/pppout.gmf~ -o 'mytmpdir'/pppout.eps~'
...
'!gxeps -R -c -s -i 'mytmpdir'/pppout.gmf~ -o 'outfile'.eps'
...
'!gxeps -R -c -i 'mytmpdir'/pppout.gmf~ -o 'outfile'.eps.clip'
...
'!gxeps -R -c -i 'mytmpdir'/pppout.gmf~ -o 'mytmpdir'/pppout.eps.clip~'
