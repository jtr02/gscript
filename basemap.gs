...
***
* please write directry where ?poly_???res.asc exist
dir='/usr/local/grads-1.9b4/lib/'
*                      arranged by Y. Kamae 08/11/09
***
...
if (type = 'L' | type = 'l') 
*  if (lowres); file = dir 'lpoly_US.asc'; endif
  if (lowres); file = dir 'lpoly_lowres.asc'; endif
  if (mres)  ; file = dir 'lpoly_mres.asc'  ; endif
  if (hires) ; file = dir 'lpoly_hires.asc' ; endif
endif
if (type = 'O' | type = 'o') 
  if (lowres); file = dir 'opoly_lowres.asc'; endif
  if (mres)  ; file = dir 'opoly_mres.asc'  ; endif
  if (hires) ; file = dir 'opoly_hires.asc' ; endif
endif
